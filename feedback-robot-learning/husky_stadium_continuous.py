...
print('hey: ', cyaw, cpith, cdist, ctarget)
...
def pause(env, time=100, indicator_file=None):
    """
...
def main():
    ...
    for i in range(timestep):
        ...
        if num < 1/3:
            ...
            pause(env, time=300, indicator_file=yellow_cube_file)
        else:
            accelerate_backward(env, time=300, indicator_file=red_cube_file)
        timestep += 1
